    ...
    <div class="right-tab">
        <div class="tab-hd flexwrap">
            ...
            <ul class="main-tab-ul flexcenter">
                <?php if ($this->member->is_admin() === 'super') { ?>
                    <li><i class="fa fa-cog"></i><a href="<?php echo site_url(config_item('uri_segment_admin')); ?>" title="관리자 페이지로 이동">관리자</a>&nbsp;|&nbsp;
                <?php } ?>
                <?php
                if ($this->member->is_member()) {
                ?>
                ...
                <?php
                    ...
                    ?>
                    <li><a href="<?php echo site_url('login?url=' . urlencode(current_full_url())); ?>">로그인</a>ㅣ</li>
