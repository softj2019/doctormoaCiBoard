...
<div class="content1 board">
        ...
        <div class="content-in">
            <div class="tab-con on" id="tab1">
                <ul class="tab-ul hidden">
                    <li><button type="button" class="on">전체</button></li>
                    <li><select name="" id="" class="">
                            <option value="">진료시간</option>
                            <option value="">진료중</option>
                            <option value="">휴일진료</option>
                        </select>
                    </li>
                    <li><button type="button">전문의</button></li>
                    <li><button type="button">여의사</button></li>
                    <li><button type="button">예약가능</button></li>
                    <li>
                        <select name="" id="">
                ...
                <?php if (element('is_admin', $view)) { ?>
                    <div><input id="all_boardlist_check" onclick="if (this.checked) all_boardlist_checked(true); else all_boardlist_checked(false);" type="checkbox" /><label for="all_boardlist_check" class="check-b"> 전체선택</label></div>
                <?php } ?>
                ...
                ?>
                    <table class="table table-hover">
                        ...
                        ?>
                            <tr>
                                <?php if (element('is_admin', $view)) { ?><th scope="row"><input type="checkbox" name="chk_post_id[]" value="<?php echo element('post_id', $result); ?>" id="chkItem_<?php echo element('post_id', $result); ?>"/><label for="chkItem_<?php echo element('post_id', $result); ?>" class="check-b">&nbsp;</label></th><?php } ?>
                    ...
                    ?>
                        <li>
                            ...
                            <a href="<?php echo element('post_url', $result); ?>" title="<?php echo html_escape(element('title', $result)); ?>">
                                <div class="tab-img">
                                    <img src="<?php echo element('thumb_url', $result); ?>" alt="<?php echo html_escape(element('title', $result)); ?>" title="<?php echo html_escape(element('title', $result)); ?>" class="thumbnail img-responsive" />
                                </div>
                                <ul class="ul2-ul">
                                    <li><a href="">사과나무치과</a></li>
                                    <li class="ul2-name"><h3>이성원</h3><span>교정과 전문의</span></li>
                                    <li>
            ...
            <div class="tab-con pb20 clearfix" id="tab2">
