...
<!--                                <span>정보공개</span>-->
                                <div class="form-text text-primary group">
                                    <div class="checkbox">
                                        ...
                                        <label for="mem_open_profile" class="check-b" > 다른분들이 나의 정보를 볼 수 있도록 합니다.</label>
...
<!--                                    <span>쪽지기능사용</span>-->
                                    <div class="form-text text-primary group">
                                        <div class="checkbox">
                                            ...
                                            <label for="mem_use_note" class="check-b" >쪽지를 주고 받을 수 있습니다. </label>
                            ...
                            <?php } ?>
                            <li>
<!--                                <span class="table-heading">이메일수신여부</span>-->
                                <div class="form-text text-primary group">
                                    <div class="checkbox">
                                        <input type="checkbox" name="mem_receive_email" id="mem_receive_email" value="1" <?php echo set_checkbox('mem_receive_email', '1', true); ?> />
                                        <label for="mem_receive_email" class="check-b" >이메일 수신 여부</label>
                                    </div>
                                </div>
                            </li>
                            <li>
<!--                                <span>SMS 문자수신</span>-->
                                <div class="form-text text-primary group">
                                    <div class="checkbox">
                                        ...
                                        <input type="checkbox" name="mem_receive_sms" id="mem_receive_sms" value="1" <?php echo set_checkbox('mem_receive_sms', '1', true); ?> />
                                        <label for="mem_receive_sms" class="check-b">SMS 문자수신 여부</label>
                            ...
                            <li>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="form-text text-primary group">
                                        <input type="text" name="captcha_key" id="captcha_key" class="form-control input px150" value="" />
